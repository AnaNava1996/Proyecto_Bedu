...
- [1. Introducción](#1-introducción)
  - [1.1 Factores relevantes en la iniciación de un incendio forestal](#11-factores-relevantes-en-la-iniciación-de-un-incendio-forestal)
    - [1.1.1 Las fuentes de calor](#111-las-fuentes-de-calor)
    - [1.1.2 La temporada](#112-la-temporada)
    - [1.1.3 Los asentamientos humanos](#113-los-asentamientos-humanos)
  - [1.3 Principales factores iniciadores de un incendio forestal](#13-principales-factores-iniciadores-de-un-incendio-forestal)
    - [1.3.1 Factores ambientales](#131-factores-ambientales)
    - [1.3.2 Factor humano](#132-factor-humano)
...
- [6. Resultados](#6-resultados)
  ...
  - [Incendios por ecorregión](#incendios-por-ecorregión)
    - [Selvas calido humedas](#selvas-calido-humedas)
    - [Elevaciones semiaridas meridoniales](#elevaciones-semiaridas-meridoniales)
    - [Desiertos de america del norte](#desiertos-de-america-del-norte)
    - [Grandes planicies](#grandes-planicies)
    - [Selvas calido secas](#selvas-calido-secas)
    - [Sierras templadas](#sierras-templadas)
    - [California mediterranea](#california-mediterranea)
  - [Incendios por tipouso de suelo](#incendios-por-tipouso-de-suelo)
    - [Manejo agricola precuario y forestal](#manejo-agricola-precuario-y-forestal)
    - [Selva alta](#selva-alta)
    - [Matorral desértico](#matorral-desértico)
    - [Matorral espinozo](#matorral-espinozo)
...
En el bosque no existe la combustión espontánea, siempre se requiere de una fuente de incandescencia externa mayor a 200°C para que ocurra un incendio. Estos puntos son los principales datos utilizados en este estudio. [[1]](#9-referencias)

#### 1.1.2. La temporada
Los incendios forestales pueden ocurrir en cualquier momento; sin embargo, en México se presentan dos temporadas de mayor incidencia: la primera, correspondiente a las zonas centro, norte, noreste, sur y sureste del país, que inicia en enero y concluye en junio. La segunda temporada inicia en mayo y termina en septiembre, y se registra en el noroeste del país. Ambas coinciden con la época de mayor estiaje (sequía) en el territorio nacional. [[1]](#9-referencias)
...
La Comisión Nacional para el Conocimiento y Uso de la Biodiversidad (CONABIO) mediante su geoportal proporciona diversos sets de datos geoespaciales temáticos relacionados con la biósfera en nuestro país. Asimismo permite descargar dichos sets de datos en diversos formatos. [[5]](#9-referencias)
...
#### 1.3.2. Factor humano
Si bien hay ciertos factores que no se pueden predecir, como la oportunidad de que una persona entre a un bosque haga un baby shower y desencadene un incendio en California, [[2]](#9-referencias) existen otros eventos de los cuales sí se puede hacer una correlación con los incendios forestales, como lo son la tala y la quema de bosques. 

Se cree que entre el 95% y el 99% de los incendios forestales son ocasionados por actividades derivadas de los humanos [[1]](#9-referencias). Entre las cuales destacan las siguientes actividades: [[3]](#9-referencias)
